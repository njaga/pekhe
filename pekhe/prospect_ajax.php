...
if ($search=="") 
{
	$reponse=$db->query("SELECT `id`, `societe`, `personne`, `telephone`, `email`, `adresse`
    FROM `prospect` 
    WHERE etat=1
...
{
	$reponse=$db->prepare("SELECT `id`, `societe`, `personne`, `telephone`, `email`, `adresse`
    FROM `prospect`
...
while ($donnees= $reponse->fetch())
{
	...
	echo "<tr>";
		...
		<td>
			...
			&nbsp&nbsp&nbsp
			<a class="red-text" href="s_prospect.php?id='.$id.'"  data-toggle="tooltip" data-placement="top" title="Supprimer" onclick="return(confirm(\'Voulez-vous supprimer ce prospect ?\'))"><i class="fas fa-times"></i></a>
			&nbsp&nbsp&nbsp
            <a class="blue-text" href="d_prospect.php?id='.$id.'" data-toggle="tooltip" data-placement="top" title="Détails" ><i class="fas fa-id-card "></i></a>
        ...
        <div class="modal-dialog cascading-modal" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header light-blue darken-3 white-text">
                    <h4 class=""><i class="fas fa-user"></i> Modification prospect</h4>
                ...
                <div class="modal-body mb-0">
                    <form method="POST" action="m_prospect_trmnt.php">
