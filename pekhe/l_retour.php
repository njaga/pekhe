...
<body style="background-image: url(<?= $image ?>m_analyse.jpg);">
    ...
    <div class="container-fluid">
        ...
        <section class="mb-5">
            ...
            <!-- Card -->
            <div class="row">
                <a href="e_retour.php" class="btn col-2 blue-gradient btn-rounded waves-effect">Ajouter +</a>
            </div>
            <div class="row">
                ...
                <div class="card card-cascade narrower col-md-12 ">
                    ...
                    <div class="view view-cascade gradient-card-header blue-gradient">
                        <h1 class="mb-0">Liste des retours</h1>
                    </div>
                    <!-- Card content -->
                        ...
                        <table class="table table-hover " id="l_employe">
                            <thead class="black ">
                                <tr>
                                    ...
                                    <td class="white-text">Commantaire</td>
                                    <td class="white-text"></td>
                                </tr>
                            </thead>
                            <tbody class="tbody">
