            ...
            <div class="modal-dialog cascading-modal" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mb-0">
                        <form method="POST" action="e_caisse_trmnt.php" enctype="multipart/form-data">
                            <input type="number" class="id" name="id" value="" hidden>
                            <div class="row">
                                <div class="col-md-5 col-sm-8">
                                    <div class="md-form">
                                        <input type="date" id="date_operation" value="<?= date('Y-m-d') ?>" name="date_operation" class="form-control datepicker" required>
