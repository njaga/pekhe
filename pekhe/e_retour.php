            ...
            <section class="mb-5 col-10 offset-md-1">
                <div class="card card-cascade narrower">
                    <div class="view view-cascade gradient-card-header blue-gradient">
                        <h4 class="mb-0"><b> Retour dotation </b></h4>
                    </div>
                    <div class="card-body card-body-cascade text-center table-responsive">
                        <form method="POST" action="e_retour_trmnt.php" id="form">
                            <!-- Info département -->
                            <div class="row">
                                <div class="col-md-2 ">
                                    <div class="md-form">
                                        <input type="text" id="date_retour" name="date_retour" class="form-control datepicker" value="<?= date('Y') . "-" . date('m') . "-" . date('d') ?>" required>
