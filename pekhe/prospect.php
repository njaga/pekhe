...
<body id="debut" class="blue-grey lighten-5" style="background-image: url(<?=$image?>wall-1979476_1280.jpg);">
    <?php
    ...
    <div class="container">
        ...
        <div class="text-left">
            <a href="" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#modalClient">Nouveau prospect
            ...
            <div class="modal-dialog cascading-modal" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header light-blue darken-3 white-text">
                        <h4 class=""><i class="fas fa-map-marker "></i> Nouveau prospect</h4>
                    ...
                    <div class="modal-body mb-0">
                        <form method="POST" action="e_prospect_trmnt.php">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="md-form">
    ...
    $(document).ready(function() {
        ...
        function l_prosprect(search) {
            $.ajax({
                type: 'POST',
                url: 'prospect_ajax.php',
                data: 'search=' + search,
