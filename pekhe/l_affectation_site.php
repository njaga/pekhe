...
$req_annee = $db->query("SELECT DISTINCT YEAR(date_debut) FROM `planning_agent` ORDER BY date_debut ASC");
            ...
            <div class="row">
                ...
                <div class="card card-cascade narrower col-md-10 offset-md-1">
                    ...
                    <div class="view view-cascade gradient-card-header blue-gradient">
                        <h1 class="mb-0">Liste des affectations</h1>
                    </div>
                    <!-- Card content -->
...
<script type="text/javascript">
    $(document).ready(function() {
        function l_abs_remp(search) {
            ...
            $.ajax({
                type: 'POST',
                url: 'l_affectation_site_ajax.php',
