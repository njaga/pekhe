...
<head>
    <title>Liste des sites archivés</title>
    <?php include 'css.php'; ?>
</head>
    ...
    <div class="card-body card-body-cascade">
        ...
        <div class="card card-cascade narrower col-10 offset-1">
            ...
            <div class="view view-cascade gradient-card-header blue-gradient">
                <h1 class="mb-0">Liste des sites archivés</h1>
            </div>
            <!-- /Card image -->
                    ...
                    <table class="table  table-hover w-auto centered  card-body ml-3">
                        <thead class="">
                            <tr>
                                ...
                                <th class="font-weight-bold text-center text-uppercase th-lg" data-field="">Date Fin</th>
