...
$reponse = $db->query("SELECT sortie_vehicule.id, CONCAT(DATE_FORMAT(`date_sortie`, '%d'), '/', DATE_FORMAT(`date_sortie`, '%m'),'/', DATE_FORMAT(`date_sortie`, '%Y')), sortie_vehicule.`heure_sortie`, sortie_vehicule.`destination`, sortie_vehicule.`motif`, CONCAT(vehicule.modele, ' ', vehicule.matricule), sortie_vehicule.`demandeur`, date_sortie, heure_sortie 
                        ...
                        <form method="POST" action="e_sortie_veh_trmnt.php">
                            <div class="row">
                                <div class="col-md-5 col-sm-6">
                                    <div class="md-form">
                                        <input type="text" id="date_sortie" value="<?= date('Y-m-d') ?>" required name="date_sortie" required class="form-control datepicker">
                                        <label for="date_sortie" class="active">Date sortie</label>
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-6">
                                    <div class="md-form">
                                        <input type="text" id="heure_sortie" name="heure_sortie" class="form-control timepicker" required>
                    ...
                    <div class="modal-body mb-0">
                        <form method="POST" action="m_sortie_veh_trmnt.php">
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-6">
                                    <div class="md-form">
                                        <input type="text" id="date_sortie" value="<?= $date_sortie ?>" required name="date_sortie" required class="form-control datepicker">
                                        <label for="date_sortie" class="active">Date sortie</label>
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-6">
                            ...
                            <div class="row">
                                <div class="form-group shadow-textarea col-12">
                                    <label for="motif"></label>
                                    <textarea class="form-control z-depth-1" value="<?= $motif ?>" id="motif" name="motif" rows="3" placeholder="Motif de la sorite.."></textarea>
                                </div>
                            </div>
                            <div class="text-center mt-4">
                                <button type="submit" class="btn blue-gradient">Enregistrer</button>
