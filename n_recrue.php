...
$req_annee = $db->query("SELECT DISTINCT YEAR(date_debut) FROM `employe` WHERE etat=1 ORDER BY date_debut");
            ...
            <div class="row">
                ...
                <div class="card card-cascade narrower col-md-12">
                    ...
                    <div class="view view-cascade gradient-card-header blue-gradient">
                        <h1 class="mb-0">Nouvelles recrues du mois de :</h1>
                    </div>
                    <!-- Card content -->
