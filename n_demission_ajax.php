...
FROM `employe` 
WHERE employe.etat=0 AND employe.date_arret BETWEEN '2023-08-26' AND '2023-09-26' " . $req_departement);
$records = $stmt->fetch();
...
FROM `employe` 
WHERE employe.etat=0 AND employe.date_arret BETWEEN '2023-08-26' AND '2023-09-26' " . $req_departement . " " . $searchQuery);
...
FROM `employe` 
WHERE employe.etat=0  AND date_arret BETWEEN '2023-08-26' AND '2023-09-26' " . $req_departement . " " . $searchQuery . " ORDER BY " . $columnName . " " . $columnSortOrder . " LIMIT :limit,:offset");
