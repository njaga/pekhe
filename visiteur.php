...
$req_annee = $db->query("SELECT DISTINCT YEAR(date_visite) FROM `visiteur` 
...
<body id="debut" class="blue-grey lighten-5" style="background-image: url(<?= $image ?>lumber-84678_1280.jpg);">
    ...
    <div class="container">
        ...
        <div class="text-left">
            <a href="" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#modalSiteForm">Nouvelle visite
            </a>
        </div>
            ...
            <div class="modal-dialog cascading-modal" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header light-blue darken-3 white-text">
                        <h4 class="">Enregistrer visiteur</h4>
                    ...
                    <div class="modal-body mb-0">
                        <form method="POST" action="e_visiteur_trmnt.php">
                            <div class="row">
                                <div class="col-md-5  col-sm-8">
                                    <div class="md-form">
                                        <input type="date" id="date_visite" value="<?= date('Y-m-d') ?>" name="date_visite" class="form-control " required>
                                        <label for="date_visite" class="active">Date visite</label>
                                    </div>
                                </div>
                                <div class="col-md-5  col-sm-8">
                                    <div class="md-form">
                                        <input type="time" id="heure_visite" name="heure_visite" class="form-control " required>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-8">
                                    <div class="md-form">
                                        <input type="text" id="visiteur" name="visiteur" class="form-control" required>
                                        <label for="visiteur" class="active">Visiteur</label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-8">
                                    <div class="md-form">
                                        <input type="text" id="personne_demandee" name="personne_demandee" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="form-group shadow-textarea col-12">
                                    ...
                                    <textarea class="form-control z-depth-1" id="motif" name="motif" rows="3" placeholder="Motif de la visite..."></textarea>
                                </div>
                            </div>
        ...
        <div class="card card-cascade narrower col-10 offset-1 ">
            ...
            <div class="view view-cascade gradient-card-header blue-gradient">
                <h1 class="mb-0">Visites du mois </h1>
            </div>
            <!-- /Card image -->
                ...
                <table class="table  table-hover w-auto centered  card-body ml-3" style="font-family:'Times new roman'; font-size:'150px'!important">
                    <thead class="">
                        <tr>
                            ...
                            <th class="font-weight-bold text-center text-uppercase th-lg" data-field="">Date visite
                            </th>
                            </th>
                            <th class="font-weight-bold text-center text-uppercase th-lg" data-field="">Visiteur
                            </th>
                            <th class="font-weight-bold text-center text-uppercase th-lg" data-field="">Personne demandée
                            </th>
                            <th class="font-weight-bold text-center text-uppercase th-lg" data-field="">Motif visite
                            </th>
                        </tr>
                    </thead>
                    <tbody>
