...
$req_annee = $db->query("SELECT DISTINCT YEAR(date_sortie) 
FROM `sortie_art` WHERE 1");
...
<body style="background-image: url(<?= $image ?>1562743_1280.jpg);">
    ...
    <div class="container-fluid">
        ...
        <section class="mb-5">
            ...
            <!-- Card -->
            <div class="row">
                <a href="" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#modalForm">Sortie
                </a>
            </div>
            <!-- Modal:  form -->
                ...
                <div class="modal-dialog cascading-modal" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mb-0">
                            <form method="POST" action="e_sortie_trmnt.php">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-8">
                                        <div class="md-form">
                                            <input type="date" id="date_sortie" name="date_sortie" class="form-control " required value="<?= date('Y-m-d') ?>">
                                ...
                                <div class="row">
                                    <div class="form-group shadow-textarea col-sm-12 col-md-10">
                                        ...
                                        <textarea class="form-control z-depth-1" id="technicien" name="technicien" rows="3" placeholder="Technicien"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group shadow-textarea col-sm-12 col-md-10">
                        ...
                        <table class="table table-hover " id="">
                            <thead class="black ">
                                <tr>
                                    ...
                                    <td class="white-text">Date sortie</td>
                                    <td class="white-text">Article </td>
                                    <td class="white-text">Qt </td>
                                    <td class="white-text">Technicien</td>
