	...
	<body style="background-image: url(<?=$image?>color-2174066_1280.png);" >
        ...
        <div class="container-fluid">
            ...
            <section class="mb-5">
                ...
                <!-- Card -->
                <div class="row">
                    <a href="e_controle_site.php" class="btn col-4 col-md-2 blue-gradient btn-rounded waves-effect">Ajouter +</a>
                </div>
                <div class="row">
                                    ...
                                    <div class="col-12 table-responsive">
                                        <table class="table table-hover center-text" id="l_controle">
                                            ...
                                            <tr >
                                                ...
                                                <td class="white-text">Contrôleur</td>
                                                <td class="white-text">Heure début</td>
                                                <td class="white-text">Heure fin</td>
                                                <td class="white-text">Contrôle</td>
                                                <td class="white-text">Site(s) contrôlé(s)</td>
                                                <td class="white-text">Site(s) non contrôlé(s)</td>
                                                <td class="white-text">Observations</td>
	...
	<script type="text/javascript">
		$(document).ready(function () {
           ...
           'columns': [
               ...
               { data: 'heure_fin' },
               { data: 'controle' },
               { data: 'nbr_site_controler' },
               { data: 'site_controle' },
               { data: 'observations' },
               { data: 'id', render: function (data, type, full, meta) {
                   return '<a data-toggle="tooltip" data-placement="top" title="Modifier"class="" href="m_controle_site.php?s=' + data + '"><i class="fas fa-pencil-alt"></i></a>&nbsp&nbsp<a class="red-text" href="s_controle_site.php?s=' + data + '" onclick="return(confirm(\'Voulez-vous supprimer cet enregistrement ?\'))"><i class="fas fa-times"></i></a>';
                   } }
               ,
               { data: 'pj', render: function (data, type, full, meta) {
