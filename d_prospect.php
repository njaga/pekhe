...
<head>
    <title>Détails prospect</title>
    <?php include 'css.php'; ?>
</head>

<body id="debut" class="blue-grey lighten-5" style="background-image: url(<?=$image?>wood.jpg);">
    <?php
                    ...
                    <div class="modal-dialog cascading-modal" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body mb-0">
                                <form method="POST" action="e_devis_trmnt.php?p=p" enctype="multipart/form-data">
