...
FROM `dotation_art_site` WHERE 1");
...
<body style="background-image: url(<?= $image ?>dfk.jpg);">
    ...
    <div class="container-fluid">
        ...
        <section class="mb-5">
            ...
            <!-- Card -->
            <div class="row">
                <a href="e_dotation_site.php" class="btn col-2 blue-gradient btn-rounded waves-effect">Ajouter +</a>
            </div>
            <div class="row">
                ...
                <div class="card card-cascade narrower col-md-12 ">
                    ...
                    <div class="view view-cascade gradient-card-header blue-gradient">
                        <h1 class="mb-0">Liste des dotations par site</h1>
                    </div>
                    <!-- Card content -->
                        ...
                        <table class="table table-hover " id="l_employe">
                            <thead class="black ">
                                <tr>
                                    ...
                                    <td class="white-text">Cein</td>
                                    <td class="white-text">Miroir</td>
                                    <td class="white-text">Smart</td>
                                    <td class="white-text">Arme</td>
                                    <td class="white-text">ChArme</td>
                                    <td class="white-text">Casque</td>
                                    <td class="white-text">Registre</td>
                                    <td class="white-text">TelSimple</td>
                                    <td class="white-text">Detect</td>
                                    <td class="white-text">ChDetec</td>
                                    <td class="white-text">Gilet</td>
                                    <td class="white-text">Tonfa</td>
                                    <td class="white-text">Torche</td>
                                    <td class="white-text"></td>
                                </tr>
                            </thead>
                            <tbody class="tbody">
